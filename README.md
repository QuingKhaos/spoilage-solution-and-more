...
[![GitHub issues: bugs](https://img.shields.io/github/issues/QuingKhaos/spoilage-solution-and-more/bug?label=Bug%20Reports&style=for-the-badge&logo=github)](https://github.com/QuingKhaos/spoilage-solution-and-more/issues?q=is%3Aissue%20state%3Aopen%20label%3Abug)
[![GitHub pull requests](https://img.shields.io/github/issues-pr/QuingKhaos/spoilage-solution-and-more?label=Pull%20Requests&style=for-the-badge&logo=github)](https://github.com/QuingKhaos/spoilage-solution-and-more/pulls)

# Spoilage Solution and More

Adds [Spoilage Solution](https://mods.factorio.com/mod/spoilage-solution-fork) support to several other mods and tweaks
it a bit. If you don't like the support for a given mod or a tweak, each one can be disabled in the mod startup settings.
